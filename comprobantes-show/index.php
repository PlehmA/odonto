...
<link
	href="https://fonts.googleapis.com/css?family=Roboto|Spectral+SC:400,700"
	rel="stylesheet">
...
<!-- Default theme -->
<link rel="stylesheet"
	href="//cdn.jsdelivr.net/npm/alertifyjs@1.11.0/build/css/themes/default.min.css" />
<!-- Semantic UI theme -->
<link rel="stylesheet"
	href="//cdn.jsdelivr.net/npm/alertifyjs@1.11.0/build/css/themes/semantic.min.css" />
<!-- Bootstrap theme -->
<link rel="stylesheet"
	href="//cdn.jsdelivr.net/npm/alertifyjs@1.11.0/build/css/themes/bootstrap.min.css" />
</head>
<body>
	<style>
* {
...
?>
  <li class="nav-item"><a class="nav-link" href="../carga-lote/">Carga
					de prestaciones</a></li>
			<li class="nav-item"><a class="nav-link active" href="#">Consulta de
					comprobantes presentados</a></li>
			<li class="nav-item mx-auto text-right"><a
				class="nav-link active text-danger" href="#" onclick="salirPag();">Salir</a>
			</li>
		</ul>
		...
		<form class="mt-5 form-inline"
			...
			<div class="form-group col-sm-2">
				<label class="mr-1">MES: </label> <input type="number" min="01"
					max="12" minlength="2" maxlength="2"
					placeholder="<?php echo date('m'); ?>"
					value="<?php echo date('m'); ?>"
					class="form-control form-control-sm" name="mesperiodo">
			</div>

			<div class="form-group col-sm-2">
				<label class="mr-1">AÑO: </label> <input type="number" min="2000"
					max="4000" minlength="4" maxlength="4"
					placeholder="<?php echo date('Y'); ?>"
					value="<?php echo date('Y'); ?>"
					class="form-control form-control-sm" name="anioperiodo">
			</div>
...
$comprobantes = pg_fetch_array($comprobanteResult, null, PGSQL_ASSOC);
  ...
  <tr>
					...
					<td class="text-right"><button class="btn btn-sm"
							onclick="mostrarComprobante();">Imprimir</button></td>
				</tr>
				<!-- TERMINA LA CONDICION WHILE -->
...
<?php pg_close($con); ?>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script
		src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.0/build/alertify.min.js"></script>
